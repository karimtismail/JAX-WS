...
public class FilmList implements java.io.Serializable {
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "fid", column = @Column(name = "FID", nullable = false)),
            @AttributeOverride(name = "length", column = @Column(name = "length")),
            @AttributeOverride(name = "price", column = @Column(name = "price", nullable = false, precision = 4, scale = 2)),
