...
public class Staff {
    ...
    public Store getManager_staff_id_store() {
        return manager_staff_id_store;
    }

    public void setManager_staff_id_store(Store manager_staff_id_store) {
        this.manager_staff_id_store = manager_staff_id_store;
    }
